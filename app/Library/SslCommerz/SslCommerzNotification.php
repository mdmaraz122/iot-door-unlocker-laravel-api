...
class SslCommerzNotification extends AbstractSslCommerz
{
    ...
    {
        $this->successUrl = route('SuccessfullySubmittedOrder');
    }
    ...
    {
        $this->failedUrl = route('FailOrderPayment');
    }
    ...
    {
        $this->cancelUrl = route('CancelOrderPayment');
    }
    ...
    {
        $this->ipnUrl = route('IpnOrderPayment');
    }
